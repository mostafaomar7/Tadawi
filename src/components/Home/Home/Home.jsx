...
import "./Home.css";
import { ShieldAlert, BrainCircuit, Search as SearchIcon, CheckCircle } from "lucide-react";
import { Link, useNavigate } from "react-router-dom";
import { motion } from "framer-motion";
import Search from "../PharmacySearch/Search"; // كومبوننت السيرش
...
const HeroSection = () => {
  ...
  const handleSearchClick = () => {
    if (searchValue.trim()) {
      // 🔹 redirect للصفحة الخاصة بالسيرش مع query
      navigate(`/pharasearch?query=${encodeURIComponent(searchValue.trim())}`);
    }
  };
  ...
  return (
    <section className="hero-section text-center text-white py-24 px-4 relative overflow-hidden">
      <div
        className="absolute inset-0 hero-background opacity-90 z-10"
        style={{
      ...
      <div className="relative z-20 max-w-4xl mx-auto">
        ...
        {/* 🔎 Search Input */}
        <motion.div
  className="max-w-xl mx-auto bg-white shadow-lg rounded-2xl p-4 flex items-center space-x-2 mb-8 border border-gray-200"
  initial={{ opacity: 0, y: -30 }}
  animate={{ opacity: 1, y: 0 }}
...
<motion.div 
      ...
      >  
        <button
          ...
          className="services bg-white text-indigo-600 font-bold px-8 py-3 rounded-full shadow-lg hover:bg-indigo transform hover:scale-105 transition-transform duration-300"
        >
          Explore Services
        </button>
        <button
          ...
          className="contact bg-transparent border-2 border-white text-white font-bold px-8 py-3 rounded-full hover:bg-white hover:text-indigo-600 transition-colors duration-300"
        >
          Contact Us
        </button>
    ...
    <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
      <div className="text-left">
        ...
        <p className="mb-4 text-slate-600 text-lg">
          Medicine shortages in Egypt are a chronic and recurring issue. Patients
          often struggle to find necessary medications, facing a system with no
          easy way to find safe alternatives or real-time stock data.
        </p>
        <p className="text-slate-600 text-lg font-medium">
          Our platform directly addresses this by providing instant, reliable
          information.
        </p>
      </div>
  ...
  const featuresData = [
    {
      ...
      description:
        "Our smart system checks for potential drug conflicts and interactions to ensure your safety.",
    ...
    },
    {
      ...
      description:
        "Instantly find safe and effective medication alternatives when your prescribed drug is unavailable.",
    ...
    },
    {
      ...
      description:
        "Quickly locate any medication with real-time availability from pharmacies near you.",
      path: "/pharasearch",
    },
  ];

  return (
    <div className="bg-white py-20 px-4" id="services">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-slate-600 mt-2">
            Everything you need for smarter medicine access.
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
        ...
        <div className="text-left">
          ...
          <p className="mb-8 text-slate-600 text-lg">
            Tadawi is a smart web platform that connects patients, doctors, and
            pharmacies in real-time to create a seamless healthcare experience.
          </p>
  ...
  <div className="cta-section text-white text-center py-20 px-4">
    <div className="max-w-3xl mx-auto">
      <h2 className="text-4xl font-bold mb-4">
        Start Your Journey with Tadawi
      </h2>
  ...
  <section className="bg-gray-100 py-16 px-4" id="contact">
    <div className="max-w-4xl mx-auto text-center">
      ...
      <p className="mb-8 text-gray-600 text-lg">
        Have questions or need assistance? Reach out to us and we’ll get back to
